    ...
    def get_latest_version():
        ...
        try:
            ...
            version_res = RequestUtils(proxies=Config().get_proxies()).get_res(
                "https://api.github.com/repos/sgpublic-forks/nas-tools-hsuyelin/releases/latest")
            commit_res = RequestUtils(proxies=Config().get_proxies()).get_res(
                "https://api.github.com/repos/sgpublic-forks/nas-tools-hsuyelin/commits/master")
